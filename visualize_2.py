...
data = {
    'Config': ['Offline_P8F2', 'Offline_P2F1', 'Offline_P0F1',
            'L10_EM256_RS49','L8_EM256_RS49', 'L4_EM256_RS49',
            'L8_EM256_RS24', 'L8_EM256_RS4',
            'L8_EM128_RS49', 'L8_EM64_RS49',
            'L8_EM64_RS24', 'L8_EM64_RS9', 'L8_EM64_RS4',
    ],
    'Params': [11.42, 11.42, 11.42,
               12.27, 9.90, 5.14,
               9.90, 9.90,
               3.13, 1.15,
               1.15, 1.15, 1.15,
               ],  # Millions
    'Performance': [0.41, 0.43, 0.47,
                    0.43, 0.43, 0.45,
                    0.44, 0.47,
                    0.44, 0.45,
                    0.47, 0.48, 0.50,
                    ],  # SELD score
    'MACs(G/s)': [4.00, 2.40, 0.80,
                  0.88, 0.70, 0.36,
                  0.91, 2.59,
                  0.27, 0.12,
                  0.17, 0.33, 0.59,
    ...
    # 'Width': [32, 32, 64, 32, 32, 64, 32, 32, 64]
}
...
plt.tight_layout()
plt.savefig('plots/model_complexity_tradeoff_1_1.png', dpi=300, bbox_inches='tight')
