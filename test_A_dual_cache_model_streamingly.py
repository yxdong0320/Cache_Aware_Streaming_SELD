...
from models.dual_mode_cache_resnet_conformer import DualModeResnetConformer
# from models.dual_mode_cache_resnet_conformer_APC import DualModeResnetConformerAPC
from models.dual_mode_cache_resnet_conformer_HPC import DualModeResnetConformerHPC
...
def main(args):
    ...
    if args['model']['type'] == 'Dualmode_seddoa_nopool':
    ...
    elif args['model']['type'] == 'Dualmode_seddoa_pool_APC':
        model = DualModeResnetConformerHPC(in_channel=args['model']['in_channel'], 
                                                    ...
                                                    num_conformer_layer = args['model']['num_conformer_layer'],
                                                    encoder_dim=args['model']['encoder_dim'],
                                                    hpc_future_steps = args['model']['apc_future_steps'],
                                                    hpc_negative_samples= 32)
