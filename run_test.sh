...
# CUDA_VISIBLE_DEVICES=1 nohup python test_A_cache_model_streamingly.py \
#      -c Test_Streamingly_Cache_RC_24h_Chunk[100,4]_8ConformerLayer_2\
#      > train_logs/Test_Streamingly_Cache_RC_24h_Chunk[100,4]_8ConformerLayer_2.log &
