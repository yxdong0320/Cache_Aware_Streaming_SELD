...
class ResnetConformer_sed_doa_nopool_TS_hidstate_att_CMAPC(nn.Module):
    def __init__(self, in_channel, in_dim, out_dim, 
                 att_context_size = [100,49], 
                 num_conformer_layer = 8,
                 encoder_dim = 256,
        ...
        self.cross_modal_apc = CrossModalAPCModule(
            ...
            future_steps = CMAPC_future_steps,
        )
        
        # 设置知识蒸馏参数
        self.use_hidden_distill = use_hidden_distill
        self.use_attn_distill = use_attn_distill
        self.use_CMAPC_distill = use_CMAPC_distill
        self.num_layers = num_layers
    ...
    def forward(self, x, resnet_cache=None, conformer_cache=None):
        if resnet_cache is None and conformer_cache is None:
            ...
            cross_modal_apc_loss = self.cross_modal_apc(conformer_outputs, t_conformer_outputs)
            ...
            if self.use_CMAPC_distill:
                result.append(cross_modal_apc_loss)
