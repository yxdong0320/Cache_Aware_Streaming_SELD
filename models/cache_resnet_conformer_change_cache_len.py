...
from .cache_conformer_change_cache_len import ConformerBlock
...
class ResnetConformer_sed_doa_nopool(nn.Module):
    def __init__(self, in_channel, in_dim, out_dim, 
        ...
        self.cache_past_len = inference_cache_len if inference_cache_len is not None else self.att_context_size[0]
        ...
        self.conformer_layers = nn.ModuleList(
            [ConformerBlock(
                ...
                inference_cache_len = inference_cache_len  # 传递给ConformerBlock
