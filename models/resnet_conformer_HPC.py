...
class ResnetConformer_sed_doa_nopool(nn.Module):
    def __init__(self, in_channel, in_dim, out_dim, hpc_future_steps = 10):
        super().__init__()
    ...
    def forward(self, x):
        ...
        hpc_loss, cpc_loss, apc_loss = self.hpc.forward(conformer_outputs)
        ...
        return pred, (hpc_loss, cpc_loss, apc_loss)