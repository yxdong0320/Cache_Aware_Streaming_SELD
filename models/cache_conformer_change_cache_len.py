...
class CausalAttention(nn.Module):
    def __init__(self, dim, heads=8, dim_head=64, dropout=0., max_pos_emb=512, att_context_size=[100,49], inference_cache_len=None):
        super().__init__()
        ...
        self.cache_drop_size = None
        # 使用推理缓存长度（如果提供），否则使用训练时的缓存长度
        self.max_cache_len = inference_cache_len if inference_cache_len is not None else att_context_size[0]
    ...
    def __init__(
        ...
        *,
        ...
        self.attn = CausalAttention(
            ...
            inference_cache_len = inference_cache_len
        )
