...
def read_wav_in_sliding_windows(wav_file, segment_length_sec=10, hop_length_sec=5):
    ...
    hop_length_samples = hop_length_sec * sr
...
def main(args):
    ...
    window_length = args['model']['window_length']  
    segment_length = args['model']['segment_length']  
    past_time = int(segment_length - 2 * window_length) # 6
    output_num_frame = args['model']['output_num_frame'] 
    time_seq_output = 1.0 / output_num_frame
    overlap_len = int((segment_length - window_length) * output_num_frame) # 70
    past_len = int((segment_length - 2 * window_length) * output_num_frame) # 40
    sr = args['model']['sr']
